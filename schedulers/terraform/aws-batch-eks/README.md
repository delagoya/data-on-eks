...
| <a name="input_name"></a> [name](#input\_name) | Name of the VPC and EKS Cluster | `string` | `"aws-batch-eks"` | no |
...
| <a name="output_batch_on_eks"></a> [batch\_on\_eks](#output\_batch\_on\_eks) |  |
